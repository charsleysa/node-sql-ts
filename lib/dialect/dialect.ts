...
import { CastNode } from '../node/cast.js';
...
import { CreateViewNode } from '../node/createView.js';
import { DefaultNode } from '../node/default.js';
import { DeleteNode } from '../node/delete.js';
import { DistinctNode } from '../node/distinct.js';
import { DistinctOnNode } from '../node/distinctOn.js';
...
import { FromNode } from '../node/from.js';
import { GroupByNode } from '../node/groupBy.js';
import { HavingNode } from '../node/having.js';
import { IfExistsNode } from '../node/ifExists.js';
import { IfNotExistsNode } from '../node/ifNotExists.js';
import { InNode } from '../node/in.js';
...
import { NotInNode } from '../node/notIn.js';
...
import { PrefixUnaryNode } from '../node/prefixUnary.js';
import { PostfixUnaryNode } from '../node/postfixUnary.js';
import { Query } from '../node/query.js';
import { RenameNode } from '../node/rename.js';
...
import { SliceNode } from '../node/slice.js';
...
import { UpdateNode } from '../node/update.js';
import { WhereNode } from '../node/where.js';
import { Table } from '../table.js';

export abstract class Dialect<ConfigType> {
 ...
 * @returns {boolean}
 */
const dontParenthesizeSubQuery = (parentQuery: Query<unknown>) => {
    if (!parentQuery) {
        return false;
    }
